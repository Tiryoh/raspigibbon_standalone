...
[[ -e /dev/rtled0 ]] || sudo insmod $HOME/raspigibbon_demo/raspigibbon_driver_installer/lib/4.1.19-v7+/rtled.ko && sudo chmod 666 /dev/rt*
[[ -e /dev/rtswitch0 ]] || sudo insmod $HOME/raspigibbon_demo/raspigibbon_driver_installer/lib/4.1.19-v7+/rtswitch.ko && sudo chmod 666 /dev/rt*
